...
<html lang="en">
	<head>
		<title>Metaldur - Super-Admin Portal</title>
		<meta charset="utf-8" />
		...
		<meta property="og:title" content="Metaldur - Super-Admin Portal" />
		<meta property="og:url" content="https://metaldur.in" />
		<meta property="og:site_name" content="Metaldur - Super-Admin Portal" />
		...
		<style>.menu-title{color:white !important;} .menu-icon i{color:white !important;} .menu-arrow:after{background-color:white !important;}</style>
	</head>
				...
				<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '200px', lg: '0'}" data-kt-sticky-animation="false">
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container" style="background:#0D3354 !important;">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
							...
							<h3 class="mt-8" style="color:#FFF !important;">Metaldur - Super-Admin Panel </h3>
							</div>
							<div class="app-navbar flex-shrink-0">
								<div class="app-navbar-item ms-1 ms-md-4">
									<a href="#" class="btn btn-icon btn-custom w-35px h-35px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										<i class="ki-solid ki-night-day theme-light-show fs-1 text-white">
										</i>
										<i class="ki-solid ki-moon theme-dark-show fs-1 text-white">
										</i>
									</a>
...
<img alt="Logo" src="<?= ASSETS_URL ?>/media/logos/favicon.ico" class="h-45px app-sidebar-logo-minimize" />
</a>
...
<?php require SA_INCLUDES_PATH . '/sidebar.php'; ?>						
</div>
